        ...
        <div className="h-full px-4 max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center">
              {/* <img src={logo} alt="logo" className="h-24 w-16 sm:h-28 sm:w-24 md:h-36 md:w-32" /> */}
              <div className="text-sm sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent transform hover:scale-105 transition-transform cursor-pointer">
                TipStack
              </div>
            </div>
            ...
            {isAuthenticated && (
              <button
                ...
                className={`flex items-center space-x-2 px-2 py-1 rounded-lg transition-all duration-200  ${currentPage === (currentPage === 'home' ? 'dashboard' : 'home')
